...
int key_right = KEY_RIGHTARROW_D;
int key_left = KEY_LEFTARROW_D;
int key_up = KEY_UPARROW_D;
int key_down = KEY_DOWNARROW_D; 
int key_strafeleft = KEY_STRAFE_L;
int key_straferight = KEY_STRAFE_R;
int key_fire = KEY_FIRE;
int key_use = KEY_USE;
int key_strafe = KEY_RALT_D;
int key_speed = KEY_RSHIFT_D; 

// 
// Heretic keyboard controls
//
 
int key_flyup = KEY_PGUP_D;
int key_flydown = KEY_INS_D;
int key_flycenter = KEY_HOME_D;

int key_lookup = KEY_PGDN_D;
int key_lookdown = KEY_DEL_D;
int key_lookcenter = KEY_END_D;

int key_invleft = '[';
int key_invright = ']';
int key_useartifact = KEY_ENTER_D;
...
int key_arti_all             = KEY_BACKSPACE_D;
int key_arti_health          = '\\';
...
int key_invpop    = 'z';
int key_invkey    = 'k';
int key_invhome   = KEY_HOME_D;
int key_invend    = KEY_END_D;
int key_invuse    = KEY_ENTER_D;
int key_invdrop   = KEY_BACKSPACE_D;
...
int key_message_refresh = KEY_ENTER_D;
int key_pause = KEY_PAUSE_D;
int key_demo_quit = 'q';
int key_spy = KEY_F12_D;
...
int key_map_north     = KEY_UPARROW_D;
int key_map_south     = KEY_DOWNARROW_D;
int key_map_east      = KEY_RIGHTARROW_D;
int key_map_west      = KEY_LEFTARROW_D;
int key_map_zoomin    = '=';
int key_map_zoomout   = '-';
int key_map_toggle    = KEY_TAB_D;
...
int key_menu_activate  = KEY_ESCAPE_D;
int key_menu_up        = KEY_UPARROW_D;
int key_menu_down      = KEY_DOWNARROW_D;
int key_menu_left      = KEY_LEFTARROW_D;
int key_menu_right     = KEY_RIGHTARROW_D;
int key_menu_back      = KEY_BACKSPACE_D;
int key_menu_forward   = KEY_ENTER_D;
int key_menu_confirm   = 'y';
int key_menu_abort     = 'n';

int key_menu_help      = KEY_F1_D;
int key_menu_save      = KEY_F2_D;
int key_menu_load      = KEY_F3_D;
int key_menu_volume    = KEY_F4_D;
int key_menu_detail    = KEY_F5_D;
int key_menu_qsave     = KEY_F6_D;
int key_menu_endgame   = KEY_F7_D;
int key_menu_messages  = KEY_F8_D;
int key_menu_qload     = KEY_F9_D;
int key_menu_quit      = KEY_F10_D;
int key_menu_gamma     = KEY_F11_D;

int key_menu_incscreen = KEY_EQUALS;
int key_menu_decscreen = KEY_MINUS_D;
...
void M_BindStrifeControls(void)
{
    ...
    key_jump     = 'a';
    key_lookup   = KEY_PGUP_D;
    key_lookdown = KEY_PGDN_D;
    key_invleft  = KEY_INS_D;
    key_invright = KEY_DEL_D;
